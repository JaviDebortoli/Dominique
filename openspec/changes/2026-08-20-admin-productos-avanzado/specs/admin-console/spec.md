...
**Type**: Delta — modifies `admin-console`. Adds add-variant, add-image, and delete-image to the "Product and Variant Management" requirement in `openspec/specs/admin-console/spec.md`.
